...
public class DrinksReaderDbHelper extends SQLiteOpenHelper {
    // If you change the database schema, you must increment the database version.
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "DrinksReader.db";

    public DrinksReaderDbHelper(Context context) {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DrinksReaderContract.DrinksTable.TABLE_NAME + " (" +
                    ...
                    DrinksReaderContract.DrinksTable.COLUMN_NAME_IMAGE + " BLOB," +
